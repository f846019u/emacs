...
;;透明化
(set-frame-parameter (selected-frame) 'alpha' (1.00 0.95))

;;タイトルバーにファイル名を表示
;;(setq frame-title-format "%b") ;ファイル名のみ
(setq frame-title-format "%f")   ;フルパス
...
;;auto-highlightを有効にする
(require 'auto-highlight-symbol)
(global-auto-highlight-symbol-mode t)

;;highlightを手動で行う。
;;(require 'highlight-symbol) 
;; Cask や package-install からの場合はauto-loads cookie があるから不要
